...
class Player extends Component {
  ...
  // I'm not the best naming convention for something like this
  // so I name it as what it does
  // like I mentioned, I don't like too much code mixed with the HTML so I create a separate function
  // I'm not sure if it is convention to do this, but this is my preference
  ...
  render(){
    ...
    // I declared it as it's own variable for the same reason as why I declare a variable for state
    const player = this.props.player;

    // Also my own personal preference to have divs in one line if it is something simple like Height:
    // It's easier for me to read since you just need to find </div> and then you know what is in it
    return (
